...
def operacion_matematica():
    ecuacion = e_numero.get()
    resultado = eval(ecuacion)
    e_numero.delete(0,END)
    e_numero.insert(0,resultado)
    i=0
...
boton_igual = Button(ventana,text='=', width=5, height=2, command= lambda: operacion_matematica())
...
boton_multiplica = Button(ventana,text='x', width=5, height=2, command= lambda: click_boton('*'))
boton_divide = Button(ventana,text='/', width=5, height=2, command= lambda: click_boton('/'))
